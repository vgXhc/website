...
A few years ago I started looking at the monthly distribution of bike crashes in Madison. It turned out that September was the month with the highest number of crashes and this was consistent over the years.  Whenever I shared the graph, people asked questions: Is biking actually more dangerous in September or are there just more people biking? How reliable is the count of crashes? Is it _all_ bike crashes or just serious or fatal ones? What's the explanation for this peak? I'll try to provide some answers, grounded in data.
