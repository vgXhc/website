...
You can click on the points to display the name. We could add the names right on the map, but as bad places cluster together (and in the case of rivers and streams, the same feature shows up multiple times), this makes for a rather messy map:
...
This also shows that the number of bad streams is inflated.
