...
places_bike_commute <- get_acs(geography = "place", table = "S0801", year = 2024,
                               cache_table = TRUE)
# 
...
# BNA ratings
bna26 <- read_csv("data/all-pfb-cr-results-2026.csv")
bna_hist <- read_csv("data/all-pfb-cr-historical-results-2026.csv")
```
